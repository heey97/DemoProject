		...
		<ul id="table24">
			...
			<li id="content">
				<ul>
					...
					<li>
<<<<<<< HEAD
						<textarea rows="20"  disabled="disabled" style="background-color:#white; font-size:inherit;"><c:out value="${vo.content}"/></textarea>
=======
...
<!-- 저장버튼 테스트를 위해 변경 --><c:if test="${sessionScope.user != null }">  <!-- 구현 완료 : 로그인 했을때 -->
			...
			<li>
				<textarea class="cmtcontent" style="border:none; resize:none;"><c:out value="${cmt.content }" /></textarea>
			</li>
			</c:forEach>
		</ul>	
	</form>
